...
import React__default, { useState, useMemo, useEffect, Component, useRef } from "react";
...
const Navigation = () => {
  ...
  const camps2026 = useMemo(() => {
    var _a2;
    return ((_a2 = campsByYear.find((x) => x.year === 2026)) == null ? void 0 : _a2.camps) ?? [];
  }, []);
          ...
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  (_a2 = document.getElementById("registrationForm")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
          ...
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  (_a2 = document.getElementById("tabere")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
                className: "inline-flex items-center",
                children: [
                  /* @__PURE__ */ jsx(MessageSquare, { className: "w-5 h-5 mr-2" }),
...
const Index = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:image", content: "https://tabere.proerudio.ro/og/herohome.jpeg" }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:image", content: "https://tabere.proerudio.ro/og/herohome.jpeg" })
    ] }),
...
const CampPage = ({ slugOverride }) => {
  ...
  if (!camp) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "p-10 text-center", children: [
      /* @__PURE__ */ jsxs(Helmet, { children: [
        /* @__PURE__ */ jsx("title", { children: "Eroare - Tabără negăsită" }),
        /* @__PURE__ */ jsx("meta", { name: "robots", content: "noindex" })
      ] }),
      /* @__PURE__ */ jsx("h1", { className: "text-xl font-bold text-red-600", children: "Eroare: Tabăra nu a fost găsită" }),
      /* @__PURE__ */ jsxs("p", { children: [
        "Slug primit: ",
        slug ? slug : "(gol)"
      ] }),
      /* @__PURE__ */ jsx("p", { children: "Verifică `campsData.ts` sau definiția rutei în App.tsx" })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:type", content: "website" }),
      /* @__PURE__ */ jsx("meta", { property: "fb:app_id", content: "" })
    ] }),
    /* @__PURE__ */ jsx(Navigation, {}),
    ...
    v.showFacilities ? /* @__PURE__ */ jsx("section", { className: "py-4 bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-start", children: [
        ...
        ((_a2 = camp.locationDescription) == null ? void 0 : _a2.image) ? /* @__PURE__ */ jsx("div", { className: "rounded-2xl overflow-hidden shadow-lg", children: /* @__PURE__ */ jsx(
          "img",
          {
      ...
      ((_b2 = camp.locationFacilities) == null ? void 0 : _b2.length) ? /* @__PURE__ */ jsx("div", { className: "mt-12", children: /* @__PURE__ */ jsx(Card, { className: "bg-card border-border", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto space-y-12", children: journal.entries.map((entry, index) => {
      ...
      return /* @__PURE__ */ jsx(Card, { className: "bg-card border-border overflow-hidden", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8", children: [
        ...
        ((_a2 = entry.images) == null ? void 0 : _a2.length) ? /* @__PURE__ */ jsx("div", { className: "mt-8 grid grid-cols-2 md:grid-cols-4 gap-4", children: entry.images.slice(0, 4).map((img, imgIndex) => /* @__PURE__ */ jsx(
          "div",
          {
...
const part4MCQ = [
  {
    id: 24,
    part: 4,
    questionHeader: "You will hear part of an interview with a marine biologist called Ed Shapiro, who is talking about a diving project in the Pitcairn Islands in the South Pacific.",
...
const LS_KEY$1 = "proerudio_fce_listening_v1";
...
function ListeningPage() {
  ...
  useEffect(() => {
    localStorage.setItem(LS_KEY$1, JSON.stringify(answers));
  }, [answers]);
  ...
  const CardShell = ({ children }) => /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-5xl px-4 pb-28 pt-6", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl border bg-white shadow-sm", children }) });
  const Header = () => /* @__PURE__ */ jsx("div", { className: "sticky top-0 z-50 w-full border-b bg-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-5xl items-center justify-between px-4 py-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "leading-tight", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: "Pro Erudio" }),
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: "FCE Listening" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "hidden items-center gap-6 md:flex", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx("div", { className: "font-semibold text-gray-900", children: "Candidate ID" }),
        /* @__PURE__ */ jsx("div", { className: "text-gray-500", children: audioPlaying ? "Audio is playing" : "Audio is paused" })
      ] }),
      !audioEnabled && /* @__PURE__ */ jsx(
        "button",
        {
          onClick: enableAudio,
  ...
  const PartNav = () => /* @__PURE__ */ jsx("div", { className: "fixed bottom-0 left-0 right-0 z-40 border-t bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-5xl px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
    /* @__PURE__ */ jsx("span", { className: "mr-2 text-xs font-semibold text-gray-700", children: "Part" }),
    [1, 2, 3, 4].map((p) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => setPart(p),
        className: [
  ...
  const TopInstruction = () => /* @__PURE__ */ jsxs("div", { className: "border-b px-6 py-5", children: [
    /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: partMeta[part].range }),
    /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-gray-600", children: part === 1 || part === 4 ? "For each question, choose the correct answer." : part === 2 ? "For questions 9–18, complete the sentences with a word or a short phrase." : "For questions 19–23, choose from the list (A–H). Use the letters only once." })
  ] });
  const FinishScreen = () => /* @__PURE__ */ jsx(CardShell, { children: /* @__PURE__ */ jsxs("div", { className: "px-6 py-6", children: [
    /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-gray-900", children: "Test finished" }),
    /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm text-gray-600", children: [
      "Your score: ",
      /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: score }),
      " / ",
      TOTAL_QUESTIONS
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-6 grid gap-3 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-gray-700", children: "Part 1" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 text-2xl font-bold text-gray-900", children: [
          breakdown.p1,
          "/8"
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-gray-700", children: "Part 2" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 text-2xl font-bold text-gray-900", children: [
          breakdown.p2,
          "/10"
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-gray-700", children: "Part 3" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 text-2xl font-bold text-gray-900", children: [
          breakdown.p3,
          "/5"
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-gray-700", children: "Part 4" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 text-2xl font-bold text-gray-900", children: [
          breakdown.p4,
          "/7"
        ] })
  ...
  const Part1or4 = (mcqs) => {
    ...
    const chosen = answers.mcq[q.id];
    return /* @__PURE__ */ jsxs(CardShell, { children: [
      /* @__PURE__ */ jsx(TopInstruction, {}),
      /* @__PURE__ */ jsxs("div", { className: "px-6 py-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-md border text-sm font-bold text-gray-900", children: q.id }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: q.questionHeader }),
            q.question ? /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm text-gray-700", children: q.question }) : null
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-6 space-y-2", children: q.options.map((opt, idx) => /* @__PURE__ */ jsxs(
          "label",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-800", children: opt })
            ]
          },
          idx
        )) })
  ...
  const Part2 = () => {
    ...
    return /* @__PURE__ */ jsxs(CardShell, { children: [
      /* @__PURE__ */ jsx(TopInstruction, {}),
      /* @__PURE__ */ jsx("div", { className: "px-6 py-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-md border text-sm font-bold text-gray-900", children: q.id }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: "The Albuquerque Balloon Festival" }),
          /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm text-gray-700", children: q.prompt }),
          /* @__PURE__ */ jsxs("div", { className: "mt-5", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-2 text-xs text-gray-500", children: "Tip: one word or a short phrase." })
          ] })
        ] })
      ] }) })
    ] });
  ...
  const Part3 = () => {
    ...
    if (!q) {
      return /* @__PURE__ */ jsxs(CardShell, { children: [
        /* @__PURE__ */ jsx(TopInstruction, {}),
        /* @__PURE__ */ jsx("div", { className: "px-6 py-6 text-sm text-gray-700", children: "Something went wrong. Please select a question again." })
      ] });
    }
    const selected = (answers.matches[q.id] || "").toUpperCase();
    return /* @__PURE__ */ jsxs(CardShell, { children: [
      /* @__PURE__ */ jsx(TopInstruction, {}),
      /* @__PURE__ */ jsx("div", { className: "px-6 py-6", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: "Options (A–H)" }),
          /* @__PURE__ */ jsx("div", { className: "mt-3 space-y-2", children: part3Options.map((opt) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 text-sm text-gray-800", children: [
            /* @__PURE__ */ jsx("span", { className: "mt-[2px] inline-flex h-6 w-6 items-center justify-center rounded-md border bg-white text-xs font-bold", children: opt.letter }),
            /* @__PURE__ */ jsx("span", { children: opt.text })
          ] }, opt.letter)) }),
          /* @__PURE__ */ jsx("div", { className: "mt-4 text-xs text-gray-500", children: "Letters can only be used once." })
        ] }),
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-md border text-sm font-bold text-gray-900", children: q.id }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: q.speakerLabel }),
            /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm text-gray-700", children: "Choose the letter (A–H) that matches how the speaker felt." }),
            /* @__PURE__ */ jsxs("div", { className: "mt-5", children: [
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  className: "w-full rounded-lg border px-4 py-3 text-sm outline-none transition duration-300 ease-in-out focus:border-[#2094F3]",
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "Select a letter" }),
                    part3Options.map((opt) => {
                      const isUsedElsewhere = usedLetters.has(opt.letter) && opt.letter !== selected;
                      return /* @__PURE__ */ jsxs("option", { value: opt.letter, disabled: isUsedElsewhere, children: [
                        opt.letter,
                        " ",
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-2 text-xs text-gray-500", children: [
                "Selected: ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-800", children: selected || "—" })
              ] })
            ] })
          ] })
        ] }) })
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsx("audio", { ref: audioRef, src: "/audio/fce-listening.mp3", preload: "auto" }),
    finished ? /* @__PURE__ */ jsx(FinishScreen, {}) : part === 1 ? Part1or4(part1MCQ) : part === 2 ? /* @__PURE__ */ jsx(Part2, {}) : part === 3 ? /* @__PURE__ */ jsx(Part3, {}) : Part1or4(part4MCQ),
    /* @__PURE__ */ jsx(PartNav, {})
  ] });
}
const tasks = [
  {
...
const getTasksForPart = (part) => tasks.filter((t) => t.part === part);
...
function WritingPage() {
  ...
  const task = tasksInPart[taskIndex];
  useEffect(() => {
  ...
  const minW = ((_a2 = task == null ? void 0 : task.constraints) == null ? void 0 : _a2.minWords) ?? 140;
  const maxW = ((_b2 = task == null ? void 0 : task.constraints) == null ? void 0 : _b2.maxWords) ?? 190;
  ...
  const Header = () => /* @__PURE__ */ jsx("div", { className: "sticky top-0 z-50 w-full border-b bg-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-6xl items-center justify-between px-4 py-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("img", { src: logo, alt: "Pro Erudio Logo", className: "h-9 w-auto object-contain" }),
      /* @__PURE__ */ jsxs("div", { className: "leading-tight", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: "Pro Erudio" }),
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: "FCE Writing" })
      ] })
    ] }),
  ...
  const LeftPrompt = () => {
    var _a3, _b3;
    if (!task) return null;
    return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "border-b px-5 py-4", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: task.title }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-gray-600", children: task.instructionTop })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "px-5 py-5 text-sm text-gray-800", children: [
        task.context.map((p, idx) => /* @__PURE__ */ jsx("p", { className: idx === 0 ? "" : "mt-3", children: p }, idx)),
        /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-lg border bg-gray-50 p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "font-semibold text-gray-900", children: task.mainPrompt }),
          (((_a3 = task.notes) == null ? void 0 : _a3.length) ?? 0) > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold uppercase tracking-wide text-gray-700", children: task.notesTitle ?? "Notes" }),
            /* @__PURE__ */ jsxs("div", { className: "mt-2 text-sm text-gray-800", children: [
              /* @__PURE__ */ jsx("div", { className: "font-semibold text-gray-900", children: "Write about:" }),
              /* @__PURE__ */ jsx("ol", { className: "mt-2 list-decimal pl-5", children: task.notes.map((n, i) => /* @__PURE__ */ jsx("li", { children: n }, i)) })
            ] })
          ] })
        ] }),
        (((_b3 = task.extraBoxLines) == null ? void 0 : _b3.length) ?? 0) > 0 && /* @__PURE__ */ jsx("div", { className: "mt-4 rounded-lg border bg-white p-4", children: task.extraBoxLines.map((line, idx) => /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-800", children: line === "" ? /* @__PURE__ */ jsx("div", { className: "h-3" }) : line }, idx)) }),
        part === 2 && /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-lg border bg-blue-50 p-4 text-sm", children: [
          /* @__PURE__ */ jsx("div", { className: "font-semibold text-gray-900", children: "Exam tip" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 text-gray-700", children: [
            "In Part 2 you should choose ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "one" }),
            " question (2–4) to answer."
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [
            [2, 3, 4].map((id) => /* @__PURE__ */ jsxs(
              "button",
              {
                onClick: () => setState((prev) => ({ ...prev, chosenPart2TaskId: id })),
                className: [
                  "rounded-md px-3 py-2 text-xs font-semibold transition duration-300 ease-in-out",
                  state.chosenPart2TaskId === id ? "bg-primary text-white" : "border bg-white text-gray-800 hover:bg-gray-50"
                ].join(" "),
                children: [
                  "Choose Q",
                  id
            ...
            state.chosenPart2TaskId && /* @__PURE__ */ jsxs("span", { className: "self-center text-xs text-gray-700", children: [
              "Selected: ",
  ...
  const RightEditor = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b px-5 py-4", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-gray-900", children: "Your answer" }),
        /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-600", children: [
          "Words:",
          " ",
          /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-wrap items-center justify-between gap-2 text-xs text-gray-600", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            "Target: ",
            /* @__PURE__ */ jsxs("span", { className: "font-semibold", children: [
              minW,
            ...
            " words",
            ((_a3 = task.constraints) == null ? void 0 : _a3.styleHint) ? /* @__PURE__ */ jsxs(Fragment, { children: [
              " ",
              "• Style: ",
              /* @__PURE__ */ jsx("span", { className: "font-semibold", children: task.constraints.styleHint })
            ] }) : null
          ] }),
          /* @__PURE__ */ jsx(
            "button",
  ...
  const Nav = () => /* @__PURE__ */ jsx("div", { className: "fixed bottom-0 left-0 right-0 z-40 border-t bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-6xl px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
    /* @__PURE__ */ jsx("span", { className: "mr-2 text-xs font-semibold text-gray-700", children: "Part" }),
    /* @__PURE__ */ jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsx("div", { className: "ml-2 flex items-center gap-2", children: tasksInPart.map((t, idx) => /* @__PURE__ */ jsx(
      "button",
      {
  ...
  const Finish = () => {
    ...
    return /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-6xl px-4 pb-24 pt-6", children: /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-white p-6 shadow-sm", children: [
      /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-gray-900", children: "Finish" }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-gray-600", children: "Writing isn’t auto-scored, but we can check if you followed the word limits." }),
      /* @__PURE__ */ jsxs("div", { className: "mt-6 grid gap-3 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-gray-700", children: "Part 1 (Question 1)" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm text-gray-700", children: [
            "Words: ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: p1Words }),
            " ",
            p1Ok ? /* @__PURE__ */ jsx("span", { className: "text-emerald-700", children: "✓ within range" }) : /* @__PURE__ */ jsx("span", { className: "text-red-600", children: "✕ out of range" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border bg-gray-50 p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-gray-700", children: "Part 2 (Choose one: Q2–Q4)" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm text-gray-700", children: [
            "Selected:",
            " ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: chosen ? `Q${chosen}` : "None" })
          ] }),
          chosenTask ? /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm text-gray-700", children: [
            "Words: ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-900", children: chosenWords }),
            " ",
            chosenOk ? /* @__PURE__ */ jsx("span", { className: "text-emerald-700", children: "✓ within range" }) : /* @__PURE__ */ jsx("span", { className: "text-red-600", children: "✕ out of range" })
          ] }) : /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-red-600", children: "Please choose one task in Part 2." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-wrap gap-2", children: [
        /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsx(Header, {}),
    finished ? /* @__PURE__ */ jsx(Finish, {}) : /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-6xl grid-cols-1 gap-4 px-4 pb-24 pt-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx(LeftPrompt, {}),
      /* @__PURE__ */ jsx(RightEditor, {})
    ] }),
    /* @__PURE__ */ jsx(Nav, {})
  ] });
}
new QueryClient();
function Layout() {
  return /* @__PURE__ */ jsx(HelmetProvider, { children: /* @__PURE__ */ jsxs(TooltipProvider, { children: [
...
const routes = [
  {
    ...
    children: [
      ...
      { path: "/fce/listening", element: /* @__PURE__ */ jsx(ListeningPage, {}) },
      { path: "/fce/writing", element: /* @__PURE__ */ jsx(WritingPage, {}) },
