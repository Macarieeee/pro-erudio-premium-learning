            ...
            <div className="mt-5 grid gap-8 lg:grid-cols-[1.45fr_0.55fr] lg:items-end">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-gray-600">
                  Testul este gândit pentru a ajuta elevul să se familiarizeze
                  cu structura examenului, să lucreze într-un ritm organizat și
                  să trimită rezultatele către profesor pentru verificare și
                  feedback.
                </p>
              </div>
