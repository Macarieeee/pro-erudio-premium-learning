...
const CAE_LISTENING_PATH = "/cae/listening";
const CAE_READING_PATH = "/cae/reading";
const CAE_WRITING_PATH = "/cae/writing";
...
const examParts = [
  {
    ...
    description:
      "Elevul ascultă extracte, interviuri și monologuri specifice nivelului CAE și răspunde la întrebările probei de Listening.",
    icon: Headphones,
    status: "Prima probă",
    path: CAE_LISTENING_PATH,
  },
  {
    title: "Reading & Use of English",
    subtitle: "Citire, vocabular și gramatică",
    description:
      "Elevul parcurge exerciții de Reading & Use of English pentru nivel C1: multiple choice, open cloze, word formation, transformations și texte complexe.",
    icon: BookOpen,
    status: "A doua probă",
    path: CAE_READING_PATH,
  },
  {
    title: "Writing",
    subtitle: "Proba scrisă",
    description:
      "Elevul redactează eseul obligatoriu și un task ales din Part 2, iar răspunsurile sunt trimise profesorului pentru evaluare.",
    icon: PenLine,
    status: "A treia probă",
    path: CAE_WRITING_PATH,
  },
];

export default function CAELandingPage() {
  const renderHeader = () => (
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <div className="text-xs text-gray-500">
              CAE / C1 Advanced Mock Test
            </div>
          </div>
        </div>

        <a
          href={CAE_LISTENING_PATH}
            ...
            <div className="mt-5 grid gap-8 lg:grid-cols-[1.45fr_0.55fr] lg:items-end">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-base leading-7 text-gray-600">
                  Parcurge o simulare digitală pentru examenul CAE / C1 Advanced,
                  organizată pe probele principale: Listening, Reading & Use of
                  English și Writing.
                </p>

                <p className="mt-3 max-w-3xl text-base leading-7 text-gray-600">
                  Testul este gândit pentru elevii care se pregătesc pentru nivelul C1,
                  cu exerciții mai complexe de înțelegere, vocabular, gramatică,
                  exprimare scrisă și ascultare. Rezultatele sunt trimise către
                  profesor pentru verificare și feedback.
                </p>
              </div>
