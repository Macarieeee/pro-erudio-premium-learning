...
import caeMockImage from "@/assets/CAE-Mock-Test-ProErudio.webp";
    ...
    <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
      <div>
        ...
        <p className="mt-3 max-w-2xl text-base leading-7 text-gray-600">
          Testul este gândit pentru elevii care vor să exerseze într-un format
          clar, organizat și apropiat de structura examenului Cambridge.
        </p>

        <div className="mt-7 flex flex-col gap-3 sm:flex-row">
          <Link
            to={CAE_LISTENING_PATH}
