...
const examParts = [
  {
    ...
    description:
      "Elevul ascultă materialul audio și răspunde la întrebările specifice probei de Listening pentru nivelul B1 Preliminary.",
    icon: Headphones,
    status: "Prima probă",
    path: PRELIMINARY_LISTENING_PATH,
  },
  {
    title: "Reading",
    subtitle: "Citire și înțelegerea textului",
    description:
      "Elevul parcurge exerciții de înțelegere a textului, vocabular și alegere a răspunsurilor corecte, într-un format apropiat de examen.",
    icon: BookOpen,
    status: "A doua probă",
    path: PRELIMINARY_READING_PATH,
  },
  {
    title: "Writing",
    subtitle: "Proba scrisă",
    description:
      "Elevul redactează răspunsurile pentru task-urile de Writing, iar lucrarea este trimisă profesorului pentru verificare și feedback.",
    icon: PenLine,
    status: "A treia probă",
    path: PRELIMINARY_WRITING_PATH,
  },
];

export default function PreliminaryLandingPage() {
  const renderHeader = () => (
