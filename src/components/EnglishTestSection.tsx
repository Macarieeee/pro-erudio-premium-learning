        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
             Te-ai înscris la taberele noastre, dar nu urmezi cursuri la Pro Erudio? Te invităm să completezi acest test online gratuit pentru a te plasa corect în grupa de engleză din tabără.
            </p>
