...
export const campsData: CampConfig[] = [
    ...
    // ================= 2025 =================
    {
        ...
        quickInfo: {
            location: "Manchester, UK (placeholder)",
            duration: "8 zile / 7 nopți (placeholder)",
        ...
        locationDescription: {
            title: "Manchester – experiență educațională în UK",
            description:
                "Program de tip școală de vară, orientat pe comunicare și experiențe culturale. Ideal pentru consolidarea limbii și a încrederii în vorbire.",
            image: heroGrosvenor,
            imageAlt: "Manchester",
        },
        locationFacilities: makeFacilities("uk"),
        includedInPrice: [
            ...
            "Cursuri de engleză",
            "Materiale de studiu",
            "Activități & excursii conform programului",
            "Însoțitor de grup",
        ],
        notIncludedInPrice: [
            "Transport avion",
            "Transferuri speciale (dacă nu sunt incluse)",
            "Asigurare de călătorie/storno",
            "Cheltuieli personale",
        ],
        activitiesDescription:
            "Cursuri de engleză + activități urbane și culturale, proiecte de grup și sesiuni de conversație. Detaliile se stabilesc în programul final.",
        activityImages: IMGSET_DEFAULT,
        discounts: [
        ...
        requiredDocuments: DEFAULT_REQUIRED_DOCS,
        form: {
            selectValue: "tabara-marea-britanie-manchester-2025",
